...
PRINT 'Number of Films after 01/01/80 = ' + CAST(@NUMFILMS AS VARCHAR(50))
PRINT 'Number of Actor Birthday after 01/01/80 = ' + CAST(@NUMACTORS AS VARCHAR(50))
PRINT 'Number of Director Birthday after 01/01/80 = ' + CAST(@NUMDIRECTORS AS VARCHAR(50))

SELECT 'Number of Director Birthday after 01/01/80', @NUMDIRECTORS
